...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_ble_lib_ios_15/flutter_ble_lib_ios_15.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_line_sdk/flutter_line_sdk.framework"
